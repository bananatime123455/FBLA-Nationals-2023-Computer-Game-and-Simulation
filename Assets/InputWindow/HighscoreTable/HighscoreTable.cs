...
public class HighscoreTable : MonoBehaviour {
    ...
    private void Awake() {
        ...
        if (highscores == null) {
            ...
            AddHighscoreEntry(875, "JOE");
            AddHighscoreEntry(600, "DAV");
            AddHighscoreEntry(150, "CAT");
            AddHighscoreEntry(600, "MAX");
            AddHighscoreEntry(400, "AAA");
            // Reload
    ...
    //clears the scores for leaderboard
